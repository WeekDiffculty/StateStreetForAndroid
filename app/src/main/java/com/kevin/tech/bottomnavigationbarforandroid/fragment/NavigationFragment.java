...
import com.kevin.tech.bottomnavigationbarforandroid.fragment.subfragment.TransactionFragment;
...
public class NavigationFragment extends Fragment implements BottomNavigationBar.OnTabSelectedListener {
    ...
    private TransactionFragment mTransationFragment;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mBottomNavigationBar.addItem(new BottomNavigationItem(R.drawable.home_fill, getString(R.string.item_home)).setInactiveIconResource(R.drawable.home).setActiveColorResource(R.color.colorPrimary).setInActiveColorResource(R.color.black_1))
                ...
                .addItem(new BottomNavigationItem(R.drawable.history_fill,getString(R.string.item_history)).setInactiveIconResource(R.drawable.history).setActiveColorResource(R.color.colorPrimary).setInActiveColorResource(R.color.black_1))
        ...
        switch (position) {
            ...
            case 3:
                if (mTransationFragment == null){
                    mTransationFragment = TransactionFragment.newInstance(getString(R.string.item_history));
                }
                beginTransaction.replace(R.id.sub_content,mTransationFragment);
                break;
            case 4:

...
//        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES);
        ...
        //解决 android.os.NetworkOnMainTheadException
...
//        mRadioMsg.setText("8");
    ...
    private void setCurrentFragment() {//设置默认选中Fragment
    ...
    @Override
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {//侧边菜单选中
